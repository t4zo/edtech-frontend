...
export default {
  data() {
    return {
      ...
      raRules: [
        ...
        v =>
          v.length <= 20 || "Registro Acadêmico deve ter menos de 20 caracteres",
          // v => !!v && !this.raCadastrado || "Registro Acadêmico já cadastrado"
      ],
      nomeRules: [
  ...
  methods: {
    async handleFormSubmit() {
      ...
      const raCadastrado = await this.$store.dispatch("alunos/addAluno", this.aluno);
      if(raCadastrado) {
